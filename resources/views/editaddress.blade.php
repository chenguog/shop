...
<form class="layui-form" action="">
    <div class="addrcon">
        <ul>
            <li><em>收货人</em><input type="text" name="address_name" id="address_name" value="{{$res->address_name}}" placeholder="请填写真实姓名"></li>
            <li><em>手机号码</em><input type="number" name="address_tel" id="address_tel" value="{{$res->address_tel}}" placeholder="请输入手机号"></li>
            <li><em>所在区域</em><input id="demo1" type="text"  name="area" value="{{$res->area}}" placeholder="请选择所在区域"></li>
            <li class="addr-detail"><em>详细地址</em><input type="text" placeholder="20个字以内" value="{{$res->address_desc}}" name="address_desc" id="address_desc" class="addr"></li>
        </ul>
